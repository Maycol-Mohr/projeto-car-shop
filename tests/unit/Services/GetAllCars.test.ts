...
describe('Deveria buscar todas os carros', function () {
  ...
  it('Deveria lancar erro de um carro com id inexistente', async function () {
    ...
    try {
      const service = new CarService();
      await service.getCarById('63319d80feb9f483ee823a3d');
    } catch (error) {
